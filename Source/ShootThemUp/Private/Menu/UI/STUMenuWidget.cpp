...
void USTUMenuWidget::InitLevelItem() 
{
    const auto STUGameInstance = GameSTUGameInstance();
    if (!STUGameInstance) return;

    checkf(STUGameInstance->GetLevelsData().Num() != 0, TEXT("Levels data nust not be empty!"));
...
USTUGameInstance* USTUMenuWidget::GameSTUGameInstance() const 
{
